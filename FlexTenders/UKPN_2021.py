...
folder = r'C:\Users\felip_001\Downloads\\'
file = 'Flexibility-Post-Tender-Report-Bids-2021_'
secure = pd.read_excel(folder + file + 'secure.xlsx', sheet_name=0)
...
plt.tight_layout()
savefolder = r'C:\Users\felip_001\Documents\Profesional\PSA-Geeps\imgs\\'
...
plt.tight_layout()
savefolder = r'C:\Users\felip_001\Documents\Profesional\PSA-Geeps\imgs\\'
f.savefig(savefolder + 'ukpn2021.png')
